...
<div class="container">
    ...
    <?= form_open("/signup/create") ?>
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="text" name="name" id="name" value="<?= old('name') ?>" placeholder="John Doe">
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="text" name="email" id="email" value="<?= old('email') ?>" placeholder="john.doe@example.com">
            </div>
        </div>
        ...
        <div class="field is-grouped">
            <div class="control">
                <button class="button is-primary" type="submit"><?= lang('Signup.sign_up') ?></button>
            </div>
